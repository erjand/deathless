param(
    [string]$CsvPath = "data/source/amulets.csv",
    [string]$OutputPath = "data/gear/amulets.lua"
)
...
$lines.Add("-- GENERATED FROM data/source/amulets.csv. DO NOT EDIT MANUALLY.")
$lines.Add("")
$lines.Add("Deathless.Data.Gear.Amulets = {")
