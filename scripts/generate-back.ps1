param(
    [string]$CsvPath = "data/source/back.csv",
    [string]$OutputPath = "data/gear/back.lua"
)
...
$lines.Add("-- GENERATED FROM data/source/back.csv. DO NOT EDIT MANUALLY.")
$lines.Add("")
$lines.Add("Deathless.Data.Gear.Back = {")
