...
Deathless.Data.Gear.Amulets = {
    { name = "Placeholder Amulet", slot = "Neck", type = "Neck", levelReq = 20, source = "Quest - Placeholder", rarity = "uncommon", itemId = 1200, tiers = { "Leveling" }, classes = { "Warrior", "Paladin", "Hunter", "Rogue", "Priest", "Mage", "Warlock", "Druid", "Shaman" } },
}
