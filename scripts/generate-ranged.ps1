param(
    [string]$CsvPath = "data/source/ranged.csv",
    [string]$OutputPath = "data/gear/ranged.lua"
)
...
$lines.Add("-- GENERATED FROM data/source/ranged.csv. DO NOT EDIT MANUALLY.")
$lines.Add("")
$lines.Add("Deathless.Data.Gear.Ranged = {")
