param(
    [string]$CsvPath = "data/source/shields.csv",
    [string]$OutputPath = "data/gear/shields.lua"
)
...
$lines.Add("-- GENERATED FROM data/source/shields.csv. DO NOT EDIT MANUALLY.")
$lines.Add("")
$lines.Add("Deathless.Data.Gear.Shields = {")
