...
13. Do not reference or search for any data from expansions, like Burning Crusade, or Wrath of the Lich King; or from Season of Mastery or Season of Discovery.
...
- level: the level of the quest (NOT the minimum level to accept it). Check the source data carefully on this - if the quest level is more than a few levels below the end boss level there is a good chance you're looking at the wrong data.
...
- startCoords: the coordinates of the NPC who gives the quest. This is required information!
- money: any monetary reward from the quest, expressed in copper (e.g. 1000 is 10s; 10000 is 1g)
