...
Deathless.UI.Views:Register("druid_talents", function(container)
    local Colors = Utils:GetColors()
    local Fonts = Deathless.UI.Fonts
    
    local title, subtitle = Utils:CreateHeader(container, "Druid Talents", "Recommended builds for Hardcore leveling", CLASS_COLOR)
    ...
    message:SetText("Druid talents coming soon.")
