param(
    [string]$CsvPath = "data/source/weapons.csv",
    [string]$OutputPath = "data/gear/weapons.lua"
)
...
$lines.Add("-- GENERATED FROM data/source/weapons.csv. DO NOT EDIT MANUALLY.")
$lines.Add("")
$lines.Add("Deathless.Data.Gear.Weapons = {")
