...
--- Priest Abilities view
Deathless.UI.Views:Register("priest_abilities", function(container)
    local Colors = Utils:GetColors()
    
    local title, subtitle = Utils:CreateHeader(container, "Priest Abilities", "All trainable abilities with costs and levels", CLASS_COLOR)
    ...
    local rawAbilities = Deathless.Data.Abilities and Deathless.Data.Abilities["Priest"] or {}
    ...
    PopulateRows = function()
        ...
        local isCorrectClass = (playerClass == "PRIEST")
