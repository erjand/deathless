...
Deathless.Data.Abilities["Priest"] = {
    ...
    { name = "Greater Heal", level = 58, rank = 4, base_cost = 44000, icon = "Spell_Holy_GreaterHeal", source = "trainer", train = "yes", spellId = 10965 },
    ...
    { name = "Holy Nova", level = 28, rank = 2, base_cost = 400, icon = "Spell_Holy_HolyNova", source = "talent", train = "yes", spellId = 15430 },
    { name = "Holy Nova", level = 36, rank = 3, base_cost = 700, icon = "Spell_Holy_HolyNova", source = "talent", train = "yes", spellId = 15431 },
    { name = "Holy Nova", level = 44, rank = 4, base_cost = 1200, icon = "Spell_Holy_HolyNova", source = "talent", train = "yes", spellId = 27799 },
    { name = "Holy Nova", level = 52, rank = 5, base_cost = 1900, icon = "Spell_Holy_HolyNova", source = "talent", train = "yes", spellId = 27800 },
    { name = "Holy Nova", level = 60, rank = 6, base_cost = 2300, icon = "Spell_Holy_HolyNova", source = "talent", train = "yes", spellId = 27801 },
    ...
    { name = "Mind Flay", level = 28, rank = 2, base_cost = 400, icon = "Spell_Shadow_SiphonMana", source = "talent", train = "yes", spellId = 17311 },
    { name = "Mind Flay", level = 36, rank = 3, base_cost = 700, icon = "Spell_Shadow_SiphonMana", source = "talent", train = "yes", spellId = 17312 },
    ...
    -- Prayer of Spirit
    { name = "Prayer of Spirit", level = 60, rank = 1, base_cost = 2300, icon = "Spell_Holy_PrayerOfSpirit", source = "talent", train = "yes", spellId = 27681 },
    ...
    { name = "Starshards", level = 34, rank = 4, base_cost = 600, icon = "Spell_Arcane_Starfire", source = "quest", train = "yes", spellId = 19302, race = { "Night Elf" } },
    { name = "Starshards", level = 42, rank = 5, base_cost = 1100, icon = "Spell_Arcane_Starfire", source = "quest", train = "yes", spellId = 19303, race = { "Night Elf" } },
    { name = "Starshards", level = 50, rank = 6, base_cost = 1500, icon = "Spell_Arcane_Starfire", source = "quest", train = "yes", spellId = 19304, race = { "Night Elf" } },
    { name = "Starshards", level = 58, rank = 7, base_cost = 2200, icon = "Spell_Arcane_Starfire", source = "quest", train = "yes", spellId = 19305, race = { "Night Elf" } },
