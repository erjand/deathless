...
Deathless.UI.Views:Register("rogue_talents", function(container)
    ...
    local title, subtitle, separator = Utils:CreateHeader(container, "Rogue Talents", "Recommended builds for leveling and endgame", CLASS_COLOR)
    
    -- Enhanced scroll frame with auto-hiding scrollbar
    local scrollFrame, scrollChild = Utils:CreateScrollFrame(container, -70, 24)
    
    local builds = Deathless.Data.Talents and Deathless.Data.Talents.Rogue or {}
    local yOffset = 0
