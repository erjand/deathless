...
--- Priest Talents view
Deathless.UI.Views:Register("priest_talents", function(container)
    local Colors = Utils:GetColors()
    
    local title, subtitle, separator = Utils:CreateHeader(container, "Priest Talents", "Recommended builds for leveling and endgame", CLASS_COLOR)
    ...
    local builds = Deathless.Data.Talents and Deathless.Data.Talents.Priest or {}
    local yOffset = 0
