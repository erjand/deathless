...
function Deathless.UI.Views.GearTemplate:Create(config)
    ...
    Deathless.UI.Views:Register(viewName, function(container)
        ...
        notes1:SetFont("Fonts\\FRIZQT__.TTF", 10, "")
        ...
        notes2:SetFont("Fonts\\FRIZQT__.TTF", 10, "")
        ...
        thItem:SetFont("Fonts\\FRIZQT__.TTF", 9, "")
        ...
        thLevel:SetFont("Fonts\\FRIZQT__.TTF", 9, "")
        ...
        thSource:SetFont("Fonts\\FRIZQT__.TTF", 9, "")
        ...
        thNote:SetFont("Fonts\\FRIZQT__.TTF", 9, "")
        ...
        for i, item in ipairs(importantGear) do
            ...
            itemName:SetFont("Fonts\\FRIZQT__.TTF", 10, "")
