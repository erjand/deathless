param(
    [string]$CsvPath = "data/source/trinkets.csv",
    [string]$OutputPath = "data/gear/trinkets.lua"
)
...
$lines.Add("-- GENERATED FROM data/source/trinkets.csv. DO NOT EDIT MANUALLY.")
$lines.Add("")
$lines.Add("Deathless.Data.Gear.Trinkets = {")
